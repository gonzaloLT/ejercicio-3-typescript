...
let titulo: string,
  ...
  vencimiento: Date,
  opcion: number = 0,
  opcionSubMenus: number = 0,
  indiceTarea: number = 0,
  editar: string,
  validarEditar: string,
  seguir: string;
...
do {
  ...
  switch (opcion) {
    ...
    case 3:
      ...
      let estadoIngresado = readline.question("3. Estado (P para pendiente, E para en curso, T para terminada, C para cancelada): ").toUpperCase();
      ...
      let dificultadIngresada = readline.question("4. Dificultad (1 para facil, 2 para medio, 3 para dificil): ");
